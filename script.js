...
if (contactForm) {
    contactForm.addEventListener('submit', async (e) => {
        ...
        if (isValid) {
            ...
            try {
                // Send data to FormSubmit.co (or configured action)
                // We add _captcha=false to avoid the captcha page for AJAX if preferred, 
                // but usually better to leave it. With AJAX, FormSubmit usually requires 
                // email activation first.
                ...
                if (response.ok) {
                    ...
                    submitBtn.style.background = 'linear-gradient(135deg, #27c93f 0%, #1ea832 100%)';
                ...
                submitBtn.innerHTML = 'Error. Please email us directly.';
